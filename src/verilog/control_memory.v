...
module control_memory (
    ...
    initial begin
        ...
        // ?????? BSA (0x28-0x2C) ??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
        // BSA: M[AR]???PC, PC???AR+1
        // ACTDR sinyali ??st mod??lde bus_sel=PC ??? DR y??klemesine d??n??????r
        ...
        // Z ko??ulu AC=0 kontrol eder; ??nce AC???DR yap??l??r
        ...
        // Register-reference ??rnekleri (iR bitine g??re ger??ek tasar??mda decode edilir)
        ...
        // ?????? iNDiRECT alt program?? (0x48-0x4A) ????????????????????????????????????????????????????????????????????????
